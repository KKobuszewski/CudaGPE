...
// some functions provided by nvidia samples
...
/*
 * This header contains definitions of CUDA functions that would be linked into gcc compiled files and other util functions.
 */
